...
set rc [catch {
  ...
  import_db {../syn_1/fpga_gate.db}
  read_sdc -ip FIFO ../../al_ip/FIFO.tcl
  place
  export_db {fpga_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file fpga_phy.area
  export_db {fpga_pr.db}
  start_timer
  report_timing -mode FINAL -net_info  -rpt_autogen true -file fpga_phy.timing
} RESULT]
if {$rc} {
